...
# Official Repository: https://github.com/Manpokr/
...
#############################################
	...
	echo "==================== INSTALLITION ====================="
	echo " "
	echo "     ~Welcome to manternet Debian 9 & 10 Autoscript~"
	echo " "
	echo "======================================================="
	echo "==================  PREMIUM SCRIPT  ==================="
	echo "======================================================="
	...
	read -p "Select: " x
if test $x -eq 1; then
echo -e "Starting Installation [manternet Premium Script]!"
apt-get install wget -y
wget https://raw.githubusercontent.com/Manpokr/vpnshh/master/Files/Binaries/setup && chmod +x setup && ./setup
